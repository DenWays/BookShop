...
{
    public partial class FormOrderEmployee : Form
    {
        ...
        private void FormOrder_Load(object sender, EventArgs e)
        {
            ...
            DBConnection.msCommand.CommandText = $"SELECT Book_name AS Название, Author_name AS Автор, " +
                ...
                $"JOIN author USING(id_author) WHERE id_order = {UCOrderEmployee.id_order};";
        ...
        private void getCheckButton_Click(object sender, EventArgs e)
        {
            ...
            DBConnection.msCommand.CommandText = $"CALL GetUserId({CurrentUser.Id_account}, 'Продавец');";
